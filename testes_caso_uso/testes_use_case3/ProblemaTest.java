...
class ProblemaTest {
	...
	void testConstroiProblemaViabilidadeInvalida() {
		...
		try {
			new Problema("Vazamento de petroleo no oceano", 6, "P15");
			fail("");
		} catch (Exception e) {
		...
		try {
			new Problema("Vazamento de petroleo no oceano", 0, "P15");
			fail("");
		} catch (Exception e) {
	...
	void testConstroiProblemaCodigoInvalido() {
		...
		try {
			new Problema("Vazamento de petroleo no oceano", 3, "");
			fail("");
		} catch (Exception e) {
		...
		try {
			new Problema("Vazamento de petroleo no oceano", 3, null);
			fail("");
		} catch (Exception e) {
