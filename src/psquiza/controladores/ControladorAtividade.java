 ...
 * 
 * Possui um ID gerador e um ID processado.
 * Possui um mapa de atividades que sao cadastradas e recuperadas
 * pelo ID: "'A' + IDPROCESSADO"
 * E possivel cadastrar, exibir e apagar uma atividade.
 * E possivel cadastrar e exibir itens de uma atividade, bem
 * contar os itens pendentes e os realizados.
 * 
...
public class ControladorAtividade {
	...
	/**
	 * Verifica se existe uma atividade a partir de seu codigo.
	 * Se a atividade existir no mapa de atividades e retornado true,
	...
	/**
	 * Constroi o controlador criando um novo mapa de atividades,
	 * definindo o id gerador como 1 inicialmente e armazenando um
	 * ID final.
	 */
	...
	/**
	 * Cadastra uma atividade no mapa de atividades.
	 * Cada atividade deve ser cadastrada com uma descricao, nivel de risco
	 * e descricao do risco.
	 * 
	 * O nivel de risco pode (deve) ser:
	 * BAIXO
	 * MEDIO
	 * ALTO
	 * 
	 ...
	 * 
	 * Caso o id seja nulo ou vazio sera lancado um IllegalArgumentException:
	 * "Campo codigo nao pode ser nulo ou vazio."
	 * Caso o id nao remeta a nenhuma atividade sera lancado um IllegalArgumentException:
	...
	/**
	 * Cadastra um item em uma atividade.
	 * O item e composto por uma String.
	 * 
	 * Caso o id seja nulo ou vazio sera lancado um IllegalArgumentException:
	 * "Campo codigo nao pode ser nulo ou vazio."
	 * Caso o item seja nulo ou vazio sera lancado um IllegalArgumentException:
	...
	/**
	 * Exibe a representacao String de atividade, que segue o padrao:
	...
	/**
	 * Retorna a quantidade itens que possui o status de PENDENTE de
	...
	/**
	 * Retorna a quantidade itens que possui o status de REALIZADO de
	 * determinada atividade.
	 * 
	 * Caso o id nao remeta a nenhuma atividade sera lancado um IllegalArgumentException:
	 * "Atividade nao encontrada"
